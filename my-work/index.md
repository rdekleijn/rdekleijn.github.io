...
- Lloyd, B., Wurm, F., de Kleijn, R., & Nieuwenhuis, S. (in press). Short-term transcutaneous vagus nerve stimulation increases pupil size but does not affect EEG alpha power: A replication of Sharon et al. (2021, Journal of Neuroscience).
- Goekoop, R., & de Kleijn, R. (2023). Hierarchical network structure as the source of power-law frequency spectra (state-trait continua) in living and non-living systems: how physical traits and personalities emerge from first principles in biophysics. [preprint [arXiv:2304.07094](https://arxiv.org/abs/2304.07094)]
