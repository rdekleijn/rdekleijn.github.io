...
- Goekoop, R., & de Kleijn, R. (in press). How higher goals are constructed and collapse under stress: a hierarchical Bayesian control systems perspective. *Neuroscience and Biobehavioral Reviews.*
- van Hoek, L., Saunders, R., & de Kleijn, R. (2020). Evolving virtual embodied agents using external artifact evaluations. *Proceedings of the 2020 Annual Benelux Conference on Artificial Intelligence and Machine Learning BNAIC/BeneLearn,* 71–87. [[PDF](../assets/pdf/2020_VanHoek_Saunders_DeKleijn_BNAIC.pdf)] 
