...
- Lloyd, B., Wurm, F., de Kleijn, R., & Nieuwenhuis, S. (2023). Short-term transcutaneous vagus nerve stimulation increases pupil size but does not affect EEG alpha power: A replication of Sharon et al. (2021, Journal of Neuroscience). *Brain Stimulation.* [doi: [10.1016/j.brs.2023.06.010](https://doi.org/10.1016/j.brs.2023.06.010)]
- Goekoop, R., & de Kleijn, R. (2023). Hierarchical network structure as the source of hierarchical dynamics (power law frequency spectra) in living and non-living systems: how state-trait continua (body plans, personalities) emerge from first principles in biophysics. [preprint [arXiv:2304.07094](https://arxiv.org/abs/2304.07094)]
