...
- Goekoop, R., & de Kleijn, R. (in press). Hierarchical network structure as the source of hierarchical dynamics (power-law frequency spectra) in living and non-living systems: how state-trait continua (body plans, personalities) emerge from first principles in biophysics. *Neuroscience and Biobehavioral Reviews.*
